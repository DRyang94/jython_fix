...
public class AccountMangerLTCBTC {
	...
	/*************************AccountMangerTest********************************/
	public AccountMangerLTCBTC(SessionID pID,float pStepPriceBase,float pTradeCount,float pOffset,String pAccKey,String pSecKey) 
	{
		this.isTest = false;
	...
	//初始化
	public AccountMangerLTCBTC(SessionID pID,float pStepPriceBase,float pTradeCount,float pOffset,boolean isTest) {
	...
	private void orderCheckAll()
	{
		new Thread(new Runnable() {
			...
			public void run() {
				...
				String ACCESS_KEY = s_accKey;//"";
			    String SECRET_KEY = s_secKey;//"MatchTuoGuan";
