...
public class AccountMangerProBTCCNY {
	...
	/*************************AccountMangerTest********************************/
	public AccountMangerProBTCCNY(SessionID pID,float pStepPriceBase,float pTradeCount,float pOffset,String pAccKey,String pSecKey) 
	{
		this.isTest = false;
	...
	//初始化
	public AccountMangerProBTCCNY(SessionID pID,float pStepPriceBase,float pTradeCount,float pOffset,boolean isTest) {
