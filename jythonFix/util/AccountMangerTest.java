...
public class AccountMangerTest {
	...
	/*************************AccountMangerTest********************************/
	public AccountMangerTest(SessionID pID,float pStepPriceBase,float pTradeCount,float pOffset,String pAccKey,String pSecKey) 
	{
		this.isTest = false;
	...
	//初始化
	public AccountMangerTest(SessionID pID,float pStepPriceBase,float pTradeCount,float pOffset,boolean isTest) {
